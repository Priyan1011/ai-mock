...
// ✅ Uses the real covers array, deterministic via interviewId
function getInterviewCover(interviewId: string) {
  const index =
    interviewId
      .split("")
...
const InterviewCard = async ({
  ...
  // ✅ Guards against undefined and invalid dates
  ...
  const coverImage = getInterviewCover(interviewId ?? "default");
